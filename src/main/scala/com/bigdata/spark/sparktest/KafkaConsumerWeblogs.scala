...
object KafkaConsumerWeblogs {
  def main(args: Array[String]) {
    val spark = SparkSession.builder.master("local[*]").appName("kafkaConsumerdemo").config("spark.logConf", "true").config("spark.logLevel", "ERROR").getOrCreate()
