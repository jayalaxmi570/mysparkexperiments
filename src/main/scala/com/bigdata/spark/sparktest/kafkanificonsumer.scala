   ...
   // val output="C:\\work\\kafkaop"
    ...
    lines.foreachRDD{ rdd =>
     ...
     df.createOrReplaceTempView("tab")
      val res=spark.sql("select nationality,r.user.cell,r.user.email from tab lateral view explode(results) t as r ")
      res.show()
     ...
     res.write.mode(SaveMode.Append).jdbc(url,"json",prop)
